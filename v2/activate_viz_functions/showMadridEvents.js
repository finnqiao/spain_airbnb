...
function showMadridEvents(svg) {
  ...
  svg.select('#madridEvents')
    .classed('noshow', false);
  var events = svg.select('#madridEvents')
    .selectAll('.mark');
  var div = d3.select('#tooltipDiv');
  ...
  events.on('mouseenter', function(d) {
    ...
    div.html(
      ...
      '<img class = "mySlides" src = ' + d.imageLink1 + ' width=300 style="padding-left: ' + (divWidth - 300) * .5 + 'px">' +
      '<img class = "mySlides" src = ' + d.imageLink2 + ' width=300 style="display: none;padding-left: ' + (divWidth - 300) * .5 + 'px">' + 
      '<img class = "mySlides" src = ' + d.imageLink3 + ' width=300 style="display: none;padding-left: ' + (divWidth - 300) * .5 + 'px">'
      )
      ...
      function showSlides() {
        ...
        if (slides[slideIndex-1]) {
          ...
          slides[slideIndex-1].style.paddingLeft = ((divWidth - 300) * .5) + 'px';
        }; 

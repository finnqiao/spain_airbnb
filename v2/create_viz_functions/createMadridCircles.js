...
function createMadridCircles(madrid, path, eventData, price_flag_color, date, year, svg) {
  var centroids = madrid.features.map(function (feature){
  ...
  var price_circles = svg.select('#madridVis')
    .append('g')
    .attr('id', 'madridCircles')
    .selectAll('.centroid')
    .data(centroids)

...
function createMadridPolarChart1(madPolarChart, width, height, svg) {
  ...
  function draw_labels(start, end, svg){
    ...
    polarChart.append('text')
      ...
      .attr('xlink:href', '#Outer_LabelsMad1') //place the ID of the path here
      .attr('class','label_text chart_labels polar_chartMad1')
      .attr('id','Start')
  ...
  function draw_polar_fans(data, svg){
    ...
    var fans = svg.select('#madridPolarChart1')
      .selectAll('.price_fan')
      .data(data);
  ...
  var newData = daily_data(madPolarChart, 2019, 1, 1, 2019, 2, 31);

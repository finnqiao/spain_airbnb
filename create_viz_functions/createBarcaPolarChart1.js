...
function createBarcaPolarChart1(barPolarChart, width, height, svg) {
  ...
  function draw_polar_fans(data, svg){
    ...
    var fans = svg.select('#barcaPolarChart1')
      .selectAll('.price_fan')
      .data(data);
  ...
  var newData = daily_data(barPolarChart, 2018, 1, 1, 2018, 2, 31);

...
function createBarcaPolarChart2(barPolarChart, width, height, svg) {
  ...
  function draw_labels(start, end, svg){
    ...
    var polarChart = svg.select('#barcaVis')
      .append('g')
      .attr('id', 'barcaPolarChart2')
  ...
  function draw_polar_fans(data, svg){
    ...
    var fans = svg.select('#barcaPolarChart2')
      .selectAll('.price_fan')
      .data(data);
  ...
  var newData = daily_data(barPolarChart, 2018, 5, 1, 2018, 5, 30);
